...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image5": {
      "custom": {
        ...
        "src": "/app-assets/pexels-foodie-factor-551991.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image6": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/restaurantin.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image19": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/locationicon.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image20": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/callonglogo.jpg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Input9": {
      "custom": {
        "value": "",
        "placeholder": "Do you have note for us?"
      },
      "callbacks": {}
    },
    "TextBox159": {
  ...
  "Menu": {
    ...
    "Image112": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Uber_Eats_2018_logo.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image117": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/DoorDash_Logo.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image118": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/postmates-2.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image119": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Rappi_textlogo.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image120": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/GoPuff_logo.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image121": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Seamless_logo.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image123": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/GrubHub_Logo_2016.svg"
      },
      "callbacks": {
        "onClick": [
          {
